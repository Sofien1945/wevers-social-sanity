...
const Discover: NextPage = () => {
  ...
  const activeTopicStyle =
    "xl:border-2 hover:bg-primary xl:border-amber-500 px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-amber-500"
  const topicStyle =
